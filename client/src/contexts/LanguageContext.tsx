...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'features.mentalHealth.title': 'Mental Health Check-ins',
    'features.mentalHealth.desc': 'Weekly wellness checks for parents with supportive guidance.',
  ...
  hi: {
    ...
    'features.mentalHealth.title': 'मानसिक स्वास्थ्य चेक-इन',
    'features.mentalHealth.desc': 'माता-पिता के लिए साप्ताहिक वेलनेस चेक।',
